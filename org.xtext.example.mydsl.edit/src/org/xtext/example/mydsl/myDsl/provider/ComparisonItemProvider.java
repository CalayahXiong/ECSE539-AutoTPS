...
/**
 * This is the item provider adapter for a {@link org.xtext.example.mydsl.myDsl.Comparison} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComparisonItemProvider extends ConditionItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MyDslPackage.Literals.COMPARISON__OPERATOR,
				 true,
				 false,
				 false,
	...
	protected void addDurationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Comparison_duration_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Comparison_duration_feature", "_UI_Comparison_type"),
				 MyDslPackage.Literals.COMPARISON__DURATION,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Comparison)object).getOperator();
