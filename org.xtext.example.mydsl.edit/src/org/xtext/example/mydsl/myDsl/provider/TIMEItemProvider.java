...
/**
 * This is the item provider adapter for a {@link org.xtext.example.mydsl.myDsl.TIME} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TIMEItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TIME_hours_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TIME_hours_feature", "_UI_TIME_type"),
				 MyDslPackage.Literals.TIME__HOURS,
				 true,
				 false,
				 false,
	...
	protected void addMinutesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TIME_minutes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TIME_minutes_feature", "_UI_TIME_type"),
				 MyDslPackage.Literals.TIME__MINUTES,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return getString("_UI_TIME_type") + " " + time.getHours();
	}
