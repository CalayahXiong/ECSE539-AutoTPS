...
/**
 * This is the item provider adapter for a {@link org.xtext.example.mydsl.myDsl.Task} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskItemProvider 
	...
	protected void addDifficultyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Task_difficulty_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Task_difficulty_feature", "_UI_Task_type"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MyDslPackage.Literals.TASK__START);
		}
		...
		newChildDescriptors.add
			(createChildParameter
				(MyDslPackage.Literals.TASK__START,
				 MyDslFactory.eINSTANCE.createTIME()));
	}
