...
/**
 * This is the item provider adapter for a {@link org.xtext.example.mydsl.myDsl.Rule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RuleItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Rule_assign_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Rule_assign_feature", "_UI_Rule_type"),
				 MyDslPackage.Literals.RULE__ASSIGN,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MyDslPackage.Literals.RULE__CONDITION);
		}
	...
	public String getText(Object object) {
		SeniorityLevel labelValue = ((Rule)object).getAssign();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MyDslPackage.Literals.RULE__CONDITION,
