...
/**
 * This is the item provider adapter for a {@link org.xtext.example.mydsl.myDsl.Worker} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WorkerItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Worker_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Worker_name_feature", "_UI_Worker_type"),
				 MyDslPackage.Literals.WORKER__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Seniority feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSeniorityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Worker_seniority_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Worker_seniority_feature", "_UI_Worker_type"),
	...
	protected void addIsActivePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Worker_isActive_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Worker_isActive_feature", "_UI_Worker_type"),
				 MyDslPackage.Literals.WORKER__IS_ACTIVE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Worker)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Worker_type") :
			getString("_UI_Worker_type") + " " + label;
	}
